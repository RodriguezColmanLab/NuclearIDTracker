...
def streamplot(axes: Axes, x, y, u, v, density=1, linewidth=None, color=None,
    ...
    for t in trajectories:
        ...
        # Add arrows at the end of each trajectory
        n = len(tx) - 1
        arrow_tail = (tx[n], ty[n])
        arrow_head = (tx[n] + (tx[n] - tx[n - 2]) / 2, ty[n] + (ty[n] - ty[n - 2]) / 2)
